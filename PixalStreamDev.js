...
async function logintest(email, password) {
  ...
  await page.waitForSelector('#innerRibbonContainer > div.groupContainer-183 > div > div > div > div:nth-child(1) > div > div > span > button.splitPrimaryButton.root-188');
  await page.click('#innerRibbonContainer > div.groupContainer-183 > div > div > div > div:nth-child(1) > div > div > span > button.splitPrimaryButton.root-188');
